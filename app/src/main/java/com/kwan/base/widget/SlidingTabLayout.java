...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void setUp(String[] tabs) {
        mTabStrip.removeAllViews();
        populateTabStrip(tabs);
    }
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        Typeface typeFace = Typeface.createFromAsset(context.getAssets(), "fonts/xhjt.ttf");
        //使用字体
    ...
    private void populateTabStrip(String[] strTabs) {

        frgCount = strTabs.length;
        ...
        for (int i = 0; i < frgCount; i++) {
            ...
            tabTitleView.setText(strTabs[i]);
            tabTitleView.setTextSize(tabTitleTextSize);
            tabTitleView.setMaxLines(1);
            ...
            tabView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    setSelectTab(index);
                    mTabClickLister.onTabClick(index);
    ...
    public interface OnTabClickLister {

        void onTabClick(int position);

    }

    private OnTabClickLister mTabClickLister;


    public void setOnTabClickLister(OnTabClickLister tabClickLister) {
        mTabClickLister = tabClickLister;
    }
